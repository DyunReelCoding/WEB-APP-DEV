        ...
        <form method="post">
                ...
                <div class='row mb-3'>
                    <div class='offset-sm-3 col-sm-6'>
                        <div class='alert alert-success alert-dismissible fade-show' role='alert'>
                            ...
                            <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='search'></button>
                        </div>
                    </div>
                </div>
                ";
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-outline-primary" href="/login-register/index.php" role="button">Cancel</a>
                </div>
            </div>
        </form>
    </div>
